...
- Dataset issues are **sub-issues**, meaning that one or more of them can be nested within project issues
...
These views are two kanban boards which show all active projects and datasets. These views are best for users who need an overview of things like activity, progress, and workload across multiple team members.
